...
<html>
  <head>
    ...
    <link href="{{ asset('css/styles_faq.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../css/font_awesome.css.css">
      ...
      <ul class="slider">
        ...
        <li>
          ...
          <section class="caption">
            <h1>Incendios</h1>
            <p>Descripcion breve sobre el particular ya que al final hay un link para descargar un <a href="">PDF</a> con info detallada</p>
          </section>
        </li>
        ...
        <li>
          ...
          <section class="caption">
            <h1>Procedimientos de Rescate</h1>
            <p>Descripcion breve sobre el particular ya que al final hay un link para descargar un <a href="">PDF</a> con info detallada</p>
          </section>
        </li>
